...
VimEnter 2023 참가비와 스탭의 개인 비용을 더해 **세이브더칠드런**에 기부하였습니다.

- 총 `700,000`원을 **세이브더칠드런**에 기부하였습니다.
    - 26명 참가비에 대해 **이벤터스**에서 정산받은 금액: `638,618`원
    - 스탭(이종립, 정경호) 개인 후원금: `61,382`원
...
![]( /resource/A1/3C4C10-123F-43E1-A636-9474A66BA549/2023-12-29-save-the-children.jpg )

후원금은 2023-12-29 금요일에 세이브더칠드런에서 결제하였습니다.
